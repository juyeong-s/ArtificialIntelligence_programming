# 목적함수: y = w1*x1+w1*x2+w3*x3+w4*x4+w5*x5+w6*x6
...
equation_inputs = [2, -3.2, 4.5, 1, -5, -1.5] # 입력 x의 값
num_weights = 6     # 모집단의 연색체 개수

sol_per_pop = 8     # 부모 선택 개수
num_parents_mating = 4

pop_size = (sol_per_pop, num_weights) # 모집단의 크기 = 모집단의 염색체 개수 x 가중치의개수
